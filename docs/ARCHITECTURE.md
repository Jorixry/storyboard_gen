...
Implemented 2026-09-22 as the mock-path finish: production adapters still arrive in Prompt 7B2 (gated on credentials), so no provider is callable yet and no credits can be spent.
